frappe.ui.form.on("Lead", {
    refresh(frm){
        ...
        $('[data-fieldname="custom_section_break_uo7ci"] div[class="section-head"]').remove()
...
function render_fields(frm) {
    ...
    $('[data-fieldname="custom_section_break_uo7ci"] div[class="section-head"]').remove()
    $('[data-fieldname="custom_section_break_uo7ci"]').prepend(`<div class="section-head">Facebook Lead Info</div>`)
